...
-(NSDictionary*) definedContacts{
    return @{\
             ...
             //Collectible
             [NSNumber numberWithInteger:COLLECTIBLE_CATEGORY_BITMASK]:@[[NSNumber numberWithInteger:RED_FISH_CATEGORY_BITMASK],[NSNumber numberWithInteger:GREEN_FISH_CATEGORY_BITMASK],[NSNumber numberWithInteger:PINK_FISH_CATEGORY_BITMASK],[NSNumber numberWithInteger:BLUE_FISH_CATEGORY_BITMASK],[NSNumber numberWithInteger:ORANGE_FISH_CATEGORY_BITMASK],[NSNumber numberWithInteger:PLAYER_CATEGORY_BITMASK]],\
             
             //Green Plant
             [NSNumber numberWithInteger:GREEN_PLANT_CATEGORY_BITMASK]: @[[NSNumber numberWithInteger:RED_FISH_CATEGORY_BITMASK],[NSNumber numberWithInteger:GREEN_FISH_CATEGORY_BITMASK],[NSNumber numberWithInteger:BLUE_FISH_CATEGORY_BITMASK],[NSNumber numberWithInteger:PINK_FISH_CATEGORY_BITMASK],[NSNumber numberWithInteger:ORANGE_FISH_CATEGORY_BITMASK],[NSNumber numberWithInteger:BLOWFISH_CATEGORY_BITMASK],[NSNumber numberWithInteger:EEL_CATEGORY_BITMASK],[NSNumber numberWithInteger:PLAYER_CATEGORY_BITMASK]],\
...
+ (void) addPlayerCategoryBitMaskFor:(CollisionConfiguration*)collisionConfiguration{
    ...
    int32_t playerCategoryBitmask = [[CollisionConfiguration playerCollisionConfiguration] categoryBitMask];
    
    int32_t modifiedCategoryBitmask = [collisionConfiguration categoryBitMask] | playerCategoryBitmask;
    
    [collisionConfiguration setCategoryBitMask:modifiedCategoryBitmask];
}
